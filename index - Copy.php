...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css" crossorigin="anonymous" />
    <link rel="stylesheet" href="style.css?v=10.8" type="text/css"></head>
	<body>
<!-- header section -->
...
<p class="text-center payment">
			...
			<div class="greybox margin-20">
                <img src="img/ship.png" alt="">
				<h2>FREE SHIPPING<span>on all orders</span></h2>
            </div>
            </div><div class="col-6 pr_0">
            <div class="greybox margin-20">
                <img src="img/phone.png" alt="">
				<h2>PHONE ORDER<span class="phnord">844-000-000</span></h2>
            </div></div></div> -->
			...
			<h3>What Our Customers Are Saying</h3>
			 <div class="owl-carousel owl-theme" id="testi">
				...
				<div class="item text-center">
					<div class="row">
						<div class="col-12">
							<div class="testi"><p>“Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.”</p>
						
							</div>
						</div>
						
							<div class="col-8 testi-name">
							<h5>Lorem Ipsum</h5>
...
<p>Peter realized that an overwhelming majority of scientists believe that declining mitochondria are responsible for “getting old.” </p>
...
<p>Just click the “Add to Cart” button you see below…</p>
